...
data <- readr::read_csv(file = here("LM051", "LM051-1_OD450.csv"), locale=locale(encoding="latin1"))
...
# ggsave(plot = cowplot, filename = here("LM051", "LM051-1_plot.png"), device = "png", height = 10, width = 10, bg = "white")
...
activityplot <- data_activity %>%
  ...
  ggtitle("LM051-1 IPF lung ALDH2 activity assay") +
  labs(caption = "Each sample represents four technical replicates. Note variation.")
  

ggsave(plot = activityplot, filename = here("LM051", "LM051-1_activityPlot.png"), device = "png", width = 6, height = 5)
